...
.addField("Announce", "Announce using webhooks.(`t.announce` for more info)")
...
.addField("Msent", "Give user info of how many messages they have sent since the logging of this command.")
.addField("Npm", "Provide user with info about a specified term.")
