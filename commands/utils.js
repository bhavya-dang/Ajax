...
.addField("`" + message.prefix + "`" + message.prefix +"decrypt`", "Decrypt an encrypted arguement.")
.addField("`" + message.prefix +"find`", "Find usernames with a given term.")
.addField("`" + message.prefix + "`" + message.prefix +"imgur`", "Get an imgur image based on the search term.")
